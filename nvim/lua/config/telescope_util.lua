    ...
    return function(opts)
        ...
        local entry_maker = function(session_name)
            return {
                ...
                cb = function() sessions.restore_session(session_name) end
            }
        end

        M.pick(opts, sessions.get_saved_sessions(), entry_maker, 0.2, 0.2, "Hint", "Sessions", "vertical")
    end
end

function M.pick(opts, results, entry_maker, width, height, prompt_title, results_title, layout_strategy)
